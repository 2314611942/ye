...
export default function ExhibitDialog({ panel, event, onClose, onStep, onEpilogue, onOpenEvent, sound, reducedMotion, setReducedMotion, showRoutes, setShowRoutes, onShare, shareUrl }) {
